...
# source: https://github.com/docker-library/postgres/blob/ef04f3055bab11b10d3d5c41a659acfacf2c850b/10/Dockerfile
...
COPY docker-build.sql /etc
COPY docker-build.sh /usr/local/bin/
RUN /usr/local/bin/docker-build.sh && rm /usr/local/bin/docker-build.sh && rm /etc/docker-build.sql
